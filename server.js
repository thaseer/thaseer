...
app.post("/api/customers/", (req, res, next) => {
    ...
    try {
        ...
        var sql = 'INSERT INTO Customers (customerName, address, joinedDate, mobileNo) VALUES (?,?,?,?)'
        var params = [customerName, address, joinedDate, mobileNo]
        db.run(sql, params, function (err, result) {
...
app.delete("/api/customers/deleteAll/:id", (req, res, next) => {
    try {
        db.run(
...
app.get("/", (req, res, next) => {
    res.json({ "message": "Thajeer Shopping" })
});
