    ...
    if (err) {
        ...
        db.run(`CREATE TABLE customer (
            ...
            if (err) {
                ...
                // Table just created, creating some rows
                var insert = 'INSERT INTO customers (customerName, address, joinedDate, mobileNo) VALUES (?,?,?,?)'
                db.run(insert, ["F.T.Ahamed", "p-17 ,al umra Road, Pottuvil-17", "20/5/2022", "0776276333"])
